...
const $$BrandHero = createComponent(($$result, $$props, $$slots) => {
  ...
  const {
    title = "Your Brand",
    subtitle = "This is some text to demonstrate the blur effect."
  } = Astro2.props;
...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, {}, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main style="position: relative;"> ${renderComponent($$result2, "BrandHero", $$BrandHero, {})} </main> ` })}`;
